...
namespace MinhaDemoMVC_5.Controllers.FilmesScaffold
{
    public class FilmeScaffoldsController : Controller
    {
        private readonly MinhaDemoMVC_5Context _context;

        public FilmeScaffoldsController(MinhaDemoMVC_5Context context)
        {
            _context = context;
        }
